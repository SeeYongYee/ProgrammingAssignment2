...
## Otherwise, it calculates the "inverse of the matrix", sets this "inverse value"
## in the cache via the setInverseMatrix function, and returned the freshly computed 
